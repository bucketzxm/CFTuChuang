		...
		<form method="POST" action="admin.php?act=db">
			<div class="tabs">
				...
				<!--Rebuild DB-->
					...
					?>
						<div class="code_box"><label><?php echo _T("admin_db_image_check");?></label><input type="button" class="button" value="<?php echo _T("admin_db_database_now");?>" onclick="document.getElementById('dbt').src ='admin.php?act=checkfoulder'" /></div>
						<?php optionDescription(_T("admin_db_rebuild_description"));?>
						<div class="code_box"><label><?php echo _T("admin_db_rebuild_check");?></label><input type="button" class="button" value="<?php echo _T("admin_db_database_now");?>" onclick="document.getElementById('dbt').src ='admin.php?act=rmid'" /></div>
