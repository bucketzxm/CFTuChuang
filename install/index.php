...
<div id="admin_bar">
	<div class="title">CF Image Hosting 安装</div>
</div>
<div id="wrap">
	<div id="content">
	...
	// License
		...
		default:
			...
			<div class="ibox">
				...
				<label for="accept"><input type="checkbox" name="accept" onclick="theChecker()" id="accept">我接受协议中的条款</label><br/>
				<input type="submit" value="开始安装" class="button" name="install">
				</form>
			</div>
			<?php
	}
...
?>
	...
	<div id="footer">
		...
		<span class="version"><b>版本：</b> <?php echo $SET_VERSION?></span>
	</div>
</html>